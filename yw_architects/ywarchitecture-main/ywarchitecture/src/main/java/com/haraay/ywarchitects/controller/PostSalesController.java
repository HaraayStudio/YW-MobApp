...
public class PostSalesController {
    ...
    public ResponseEntity<ResponseStructure<PostSalesDTO>> create(@RequestBody PostSales postSales,@RequestParam boolean isOldClient) {
        return postSalesService.createPostSales(postSales,isOldClient);
    }
