...
public class ProjectService {
	...
	public ResponseEntity<ResponseStructure<ProjectDTO>> updateProject(Long projectId, Project newProject,
		...
		if (logoFile != null && !logoFile.isEmpty()) {
			...
			//23/03 Delete old logo from S3 first 
		    if (existingProject.getLogoUrl() != null && !existingProject.getLogoUrl().isBlank()) {
		        s3Service.deleteFileByUrl(existingProject.getLogoUrl());
		    }
