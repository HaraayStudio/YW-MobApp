...
class MaterialsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final materials = [
      ...
      {
        'name': 'Teak Wood Flooring — 18mm',
        'vendor': 'WoodCraft India',
        'qty': '180 sq.ft',
        'rate': '₹420/sqft',
        'total': '₹75,600',
