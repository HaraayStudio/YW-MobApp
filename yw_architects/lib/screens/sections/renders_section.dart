...
class RendersSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final jobs = [
      {
        'title': 'Sunrise Villa — Living Room Exterior',
        'project': 'Sunrise Villa',
        'task': 'Exterior Perspective Render',
        'views': 3,
        'feedback': 2,
        'status': 'In Progress',
        'due': 'Tomorrow',
      ...
      {
        'title': 'Metro Office — Reception Lobby',
        'project': 'Metro Office',
        'task': 'Interior Walk-through',
        'views': 1,
        'feedback': 0,
        'status': 'Pending',
        'due': '30 Mar',
      ...
      {
        'title': 'Green Residency — Master Bedroom',
        'project': 'Green Residency',
        'task': 'Interior Render Set',
        'views': 5,
        'feedback': 1,
        'status': 'Review',
        'due': '27 Mar',
          ...
          Row(
            ...
            children: [
              const Expanded(
                child: SectionHeader(
                  title: '3D Renders',
                  subtitle: 'Visualization workspace',
                ),
              ),
              if (canUpload)
                GestureDetector(
