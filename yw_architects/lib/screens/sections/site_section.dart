...
class SiteSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final snags = [
      {'title': 'Crack in south wall column — G/F', 'area': 'Ground Floor', 'severity': 'High', 'status': 'Open'},
      {'title': 'Drainage slope incorrect — Toilet 2', 'area': 'First Floor', 'severity': 'Medium', 'status': 'In Review'},
      {'title': 'Door frame misalignment — Room 4', 'area': 'First Floor', 'severity': 'Low', 'status': 'Fixed'},
    ];
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const SectionHeader(title: 'Site Updates', subtitle: 'GPS tracking & daily logs'),
                      ...
                      const Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 4),
                            Text('Sunrise Villa Site', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: AppColors.primary)),
                            Text('Baner, Pune — 18.560° N, 73.776° E', style: TextStyle(fontSize: 10, color: AppColors.onSurfaceVariant)),
                          ],
                        ),
                      ),
                    ],
                      ...
                      Row(children: [
                        Expanded(child: Container(
                          ...
                          child: const Column(children: [
                            Text('Checked In', style: TextStyle(fontSize: 11, color: AppColors.onSurfaceVariant)),
                            Text('08:45 AM', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: AppColors.primary)),
                          ]),
                        )),
                        ...
                        Expanded(child: Container(
                          ...
                          child: const Column(children: [
                            ...
                            Text('Active', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: AppColors.onSurfaceVariant)),
                          ]),
                        )),
                      ]),
              ...
              children: [
                const Row(
                  children: [
                    ...
                    SizedBox(width: 8),
                    Text('Upload Progress Photos', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15, color: AppColors.onSurface)),
                  ],
                ),
              ...
              child: Column(
                children: [
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Expanded(child: Text(s['title']!, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 13, color: AppColors.onSurface))),
                      const SizedBox(width: 8),
                      GoldChip(
                        text: s['severity']!,
                        bg: s['severity'] == 'High' ? AppColors.chipProgressBg : s['severity'] == 'Medium' ? AppColors.chipPlanningBg : AppColors.chipDoneBg,
                        fg: s['severity'] == 'High' ? AppColors.chipProgressFg : s['severity'] == 'Medium' ? AppColors.chipPlanningFg : AppColors.chipDoneFg,
                      ),
                    ],
                  ),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(s['area']!, style: const TextStyle(fontSize: 11, color: AppColors.onSurfaceVariant)),
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButton<String>(
            ...
            style: const TextStyle(fontSize: 12, color: AppColors.onSurface, fontFamily: 'PlusJakartaSans'),
...
class _MapGridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = const Color(0xFF755B00).withOpacity(0.2)
      ..strokeWidth = 0.5;
    const step = 20.0;
