...
public class InvoiceController {
    ...
    public ResponseEntity<ResponseStructure<ProformaInvoiceDTO>> createProforma(
    ...
    public ResponseEntity<ResponseStructure<ProformaInvoiceDTO>> updateProforma(
    ...
    public ResponseEntity<ResponseStructure<TaxInvoiceDTO>> convertToTaxInvoice(
    ...
    public ResponseEntity<ResponseStructure<TaxInvoiceDTO>> createTaxInvoice(
            @PathVariable Long postSalesId,
